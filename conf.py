...
latex_elements = {
    ...
    'preamble': r'''
        ...
        %% %\fancyfoot[R]{\ifthenelse{\isodd{\value{page}}}{{\t} }{\href{}{\tiny PythonDSP}}}
        ...
        \vfill
        \small \textit{More documents are available at }{\href{https://github.zhaw.ch}{github.zhaw.ch}}
        \end{titlepage}
        \clearpage
        \pagenumbering{roman}
        \tableofcontents
...
latex_documents = [
    (master_doc, 'main.tex', 'IoT Laboratories',
    '', 'report')
]
